...
## Project Structure
    ...
    ├── testapiautosetting_127274  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_127274`
...
2. Clone this repo and `cd testapiautosetting_127274`
